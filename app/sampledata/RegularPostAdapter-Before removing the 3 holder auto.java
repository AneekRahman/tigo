...
public class RegularPostAdapter extends RecyclerView.Adapter<RegularPostAdapter.MyViewHolder> {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        private ImageView mPostDpImageView, mBufferingSpinner, mHeartImageView, mCommentImageView, mFullscreenIcon;
        ...
        private MyViewHolder(View view) {
            ...
            mPostTitle = (TextView) view.findViewById(R.id.regular_post_title);
            ...
            mPostCountsHolder = (LinearLayout) view.findViewById(R.id.post_counts_holder);
